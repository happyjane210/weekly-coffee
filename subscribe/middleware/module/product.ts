...
// product 원산지 별 조회
export const requestFetchCountry = createAction(
  `${productReducer.name}/requestFetchCountry`
);
...
function* fetchCountryData() {
  yield console.log("--fetchCountryData--");

  const result: AxiosResponse<ProductItem[]> = yield call(
    productApi.fetchCountry
  );
...
export default function* productSaga() {
  ...
  yield takeLatest(requestFetchCountry, fetchCountryData);
}
